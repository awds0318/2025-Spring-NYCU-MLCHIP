...
{	
	...
	sc_buffer<bool> out_valid_softmax;
	
	sc_vector<sc_buffer<double> > img_out("img_out", 150528);
	sc_vector<sc_buffer<double> > conv0_out("conv0_out", 193600);
	sc_vector<sc_buffer<double> > max0_out("max0_out", 46656);
	sc_vector<sc_buffer<double> > conv1_out("conv1_out", 139968);
	sc_vector<sc_buffer<double> > max1_out("max1_out", 32448);
	sc_vector<sc_buffer<double> > conv3_out("conv3_out", 43264);
	sc_vector<sc_buffer<double> > conv2_out("conv2_out", 64896);
	sc_vector<sc_buffer<double> > conv4_out("conv4_out", 43264);
	sc_vector<sc_buffer<double> > max2_out("max2_out", 9216);
	sc_vector<sc_buffer<double> > linear0_out("linear0_out", 4096);
	sc_vector<sc_buffer<double> > linear1_out("linear1_out", 4096);
	sc_vector<sc_buffer<double> > linear2_out("linear2_out", 1000);
	sc_vector<sc_buffer<double> > softmax_out("softmax_out", 1000);
	sc_vector<sc_buffer<double> > softmax_linear("softmax_linear", 1000);
