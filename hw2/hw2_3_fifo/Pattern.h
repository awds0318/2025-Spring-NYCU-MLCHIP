...
SC_MODULE(Pattern)
{
	...
	sc_vector<sc_fifo_in<double> > output_softmax{"output_softmax", 1000};
	sc_vector<sc_fifo_in<double> > output_linear{"output_linear", 1000};
	
	sc_out<bool> rst, in_valid;
	sc_vector<sc_fifo_out<double> > img{"img", 150528};
